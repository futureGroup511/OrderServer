...
<body onunload="window.opener.location.reload();">  
        <div class="box">
        <div class="xinxi">
            <form action="<%=path%>/goods/Order_ordermodify" method="post" onsubmit="subform();">
            <table width="400" border="1" cellspacing="0" >
  <tr>
    <td height="45" valign="middle"> <font color="#666666">桌号</font></td>
    <td valign="middle"><input type="text"name="tablenum"placeholder="当前桌号"onfocus="this.blur()" value="${requestScope.order.tablenum }"/></td>
  </tr>
  <tr>
    <td height="42" valign="middle"><font color="#666666">总价</font></td>
    <td valign="middle"><input type="text" name="ordercount" placeholder="当前总价"
           title="只能输入数字"
           required="required"  pattern="^[0-9]*$" value="${requestScope.order.ordercount }"/></td>
  </tr>
  <tr>
    <td height="39" valign="middle"> <font color="#666666">日期</font></td>
    <td valign="middle"><input type="tetx" name="datetime" placeholder="当前日期" 
           onclick="fPopCalendar(event,this,this)" 
           onfocus="this.select()" readonly="readonly" required="required" value="${requestScope.order.orderdate }"/></td>
  </tr>
  <div class="anniu">
  ...
  <tr>
    <td height="40" align="center" valign="middle"><input type="reset" name="chongzhi" value="重置" /></td>
    ...
    <!--      <form action="" method="post">
           <font color="#666666">桌号</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input type="text"name="zhuohao"placeholder="当前桌号"onfocus="this.blur()"/><br /><br />
           <font color="#666666">总价</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input type="text" name="zongjia" placeholder="当前总价"
           title="只能输入数字"
           required="required"  pattern="^[0-9]*$"/><br /><br />
           <font color="#666666">日期</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input type="tetx" name="riqi" placeholder="当前日期" 
           onclick="fPopCalendar(event,this,this)" 

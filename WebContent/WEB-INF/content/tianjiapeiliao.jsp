...
<body>
  ...
  <tr>
    ...
    <td valign="middle"><input type="text" name="goodssource" required="required" /></td>
  </tr>
  <tr>
    <td height="37" valign="middle"> <font color="#666666">购进日期</font></td>
    <td valign="middle"><input type="text" name="buyindate" onclick="fPopCalendar(event,this,this)" 
           onfocus="this.select()" readonly="readonly" required="required"/></td>
  </tr>
  <tr>
    <td height="34" valign="middle"><font color="#666666">单价</font></td>
    <td valign="middle"><input  type="text" name="price" required="required" placeholder="请输入大于0的数字"
           pattern="^\+?[1-9][0-9]*$"/></td>
  </tr>
  <tr>
    <td height="34" valign="middle"><font color="#666666">购进数量</font></td>
    <td valign="middle"> <input type="text" name="num" required="required"placeholder="请输入大于0的数字"
           pattern="^\+?[1-9][0-9]*$"/></td>
  </tr>
  <div class="anniu">
  <tr>
    ...
    <td align="center" valign="middle"><input type="submit" value="提交" />  </td>
          ...
          <!--<form action="" method="post">
           ...
           <input type="text"name="mingcheng"  required="required"  /><br /><br />
           <font color="#666666">购进地</font>&nbsp;&nbsp;&nbsp;
           <input type="text" name="goujindi" required="required" /><br /><br />
           <font color="#666666">购进日期</font>
           <input type="text" name="time" onclick="fPopCalendar(event,this,this)" 
           onfocus="this.select()" readonly="readonly" required="required"/><br /><br />
           <font color="#666666">单价</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input  type="text" name="danjia" required="required" placeholder="请输入大于0的数字"
           pattern="^\+?[1-9][0-9]*$"/><br /><br />
         
           <font color="#666666">购进数量</font>
           <input type="text" name="shuliang" required="required"placeholder="请输入大于0的数字"
           pattern="^\+?[1-9][0-9]*$"/>

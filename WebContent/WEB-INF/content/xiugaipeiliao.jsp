...
<body onunload="window.opener.location.reload();"> 
  <div class="box">
        <div class="xinxi"> 
        <form action="<%=path%>/goods/Ingredient_inmodify" method="post"  onsubmit="subform();">
        <table width="400" border="0" cellspacing="0">
  <tr>
    <td height="39" valign="middle"><font color="#666666">名称</font></td>
    <td valign="middle"><input type="text"name="goodsname" placeholder="当前名称"onfocus="this.blur()" value="${requestScope.ingredient.goodsname }"/></td>
  </tr>
  
  <tr>
    <td height="35" valign="middle"> <font color="#666666">购进地</font></td>
    <td valign="middle"><input type="text" name="goodssource" placeholder="当前购进地" required="required" value="${requestScope.ingredient.goodssource }"/></td>
  </tr>
  <tr>
    <td height="44" valign="middle"><font color="#666666">购进日期</font></td>
    <td valign="middle"><input type="date" name="buyindate" placeholder="当前购进日期" 
           onclick="fPopCalendar(event,this,this)" 
           onfocus="this.select()" readonly="readonly" required="required" value="${requestScope.ingredient.buyindate }"/></td>
  </tr>
  <tr>
    <td height="42" valign="middle"><font color="#666666">单价</font></td>
    <td valign="middle"><input  type="number" name="price" placeholder="当前单价"
           title="只能输入数字"	
           required="required"  pattern="^[0-9]*$" value="${requestScope.ingredient.price }"/></td>
  </tr>
  
  <tr>
    <td height="40" valign="middle"><font color="#666666">购进数量</font></td>
    <td valign="middle"><input type="text" name="num" required="required"placeholder="当前数量"
           pattern="^\+?[1-9][0-9]*$" value="${requestScope.ingredient.num }"/></td>
           
  </tr>
  <div class="anniu">
  <tr>
    <td height="39" align="center" valign="middle"><input type="reset" name="chongzhi" value="重置" /></td>
    <td align="center" valign="middle"><input type="submit"name="tijiao" value="修改" />  </td>
        ...
        <!--  <form action="" method="post">
           ...
           <input type="text"name="mingcheng" placeholder="当前名称"onfocus="this.blur()"/><br /><br />
           <font color="#666666">购进地</font>&nbsp;&nbsp;&nbsp;
           <input type="text" name="goujindi" placeholder="当前购进地" required="required"/><br /><br />
           <font color="#666666">购进日期</font>
           <input type="date" name="time" placeholder="当前购进日期" 
           onclick="fPopCalendar(event,this,this)" 
           onfocus="this.select()" readonly="readonly" required="required"/><br /><br />
           <font color="#666666">单价</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input  type="number" name="danjia" placeholder="当前单价"
           title="只能输入数字"
           required="required"  pattern="^[0-9]*$"/><br /><br />
         
           <font color="#666666">购进数量</font>
           <input type="number" name="shuliang" placeholder="当前购进数量"
           required="required" placeholder="请输入大于0的数字"
           pattern="^\+?[1-9][0-9]*$"/>

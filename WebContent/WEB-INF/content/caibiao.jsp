...
<script LANGUAGE="JavaScript"> 
  ...
  function openwin1() { 
  	window.open ("<%=path%>/goods/Vs_vsaddreflect", "", 
  ...
  function queren(str)
	...
	if (se==true)
	  {	
		 window.location.href='<%=path%>/goods/Vs_deleteVs.action?vsname='+str; 
	  }
	}
...
<body>
    <div class="zuos">
          ...
          <div class="zsyonghu">
                    <font size="1">${sessionScope.loginUserName}</font><br />
       ...
       <table width="148"  cellpadding="0" cellspacing="0" >
          <tr>
            <td height="40" align="center" valign="middle"background="../images/zitibeijing.png">                    
             <a href="<%=path%>/goods/Vs_queryAllVs"><font color="#FF0000">菜表</font></a></td>
          </tr>
          <tr>
            <td height="40" align="center" valign="middle"background="../images/zitibeijing.png">                      
     ...
     <div class="youx">
       ...
       <div class="yxdy">
         <!--    <font color="#333333">共<font color="#FF0000">5</font>页&nbsp;|&nbsp;第<font color="#FF0000" > </font>页</font> -->
            &nbsp;&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath }/users/User_page?number=3">首页</a>&nbsp;|
            <a href="${pageContext.request.contextPath }/users/User_page?number=1">上一页</a>&nbsp;|

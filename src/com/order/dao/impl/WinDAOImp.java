...
public class WinDAOImp extends DAO<BaseGoodsInfo> implements VegetableDAO{
	
	@Override
	public void save(AlllInfoVegetable vegetable) {
		String sql = "insert into table_win(goodsname,goodsdesc,price,path)value(?,?,?,?)";
	...
	public List<BaseGoodsInfo> getAll() {
		String sql ="select goodsname,goodsdesc,price from table_win";
		return getForList(sql);
	}
	
	@Override
	public void delete(String name) {
		String sql = "delete from table_win where goodsname = ?";
		update(sql, name);
	}
	...
	public void update(BaseGoodsInfo vegetable) {
		...
		String sql = "update table_win set price=?, goodsdesc=? where goodsname=?";
		update(sql, vegetable.getPrice(),vegetable.getGoodsdesc(),vegetable.getGoodsname());
	}
	
	@Override
	public BaseGoodsInfo get(String name) {
		String sql ="select goodsname, price,goodsdesc from table_win where goodsname=?";
		return  get(sql, name);
	}
	@Override
